...
function M.evaluate(states, obs, t)
	...
	out.is_extreme_heat = M.hysteresis(
		out.is_extreme_heat,
		obs.feelsLikeF or obs.tempF,
		t.extreme_heat_enter_f,
		t.extreme_heat_exit_f,
		false
	)
	...
	out.is_poor_visibility = M.hysteresis(
		out.is_poor_visibility,
		obs.visibilityMi,
		t.poor_visibility_enter_mi,
		t.poor_visibility_exit_mi,
		true
	)
