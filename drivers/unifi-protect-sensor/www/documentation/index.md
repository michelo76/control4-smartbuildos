...
One instance per Protect sensor, bound to the UniFi Protect Gateway (SBOS) in
the Connections view. No credentials live here.
...
- Variables: CONTACT_STATE, MOTION_DETECTED, TEMPERATURE, HUMIDITY, LIGHT_LEVEL,
  BATTERY, LAST_MOTION.
