...
| 5 Agent licensing | driver repo | Connector fetches + HMAC-verifies + caches entitlements (24h revalidate / 7d offline cache / 10d grace — server-configurable), answers real statuses | after 3-4 |
